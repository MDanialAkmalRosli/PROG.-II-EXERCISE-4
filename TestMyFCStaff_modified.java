import java.util.Scanner;
   ...
   class MyFCStaff_Ex4 {   // class MyFCStaff
   
      String name, staffID;
      double work_hrs, total_sales, total_salary, commission;
     
      // constructor
      public MyFCStaff_Ex4(String name, String staffID, double work_hrs, double total_sales) {
         this.name = name;
         this.staffID = staffID;
         this.work_hrs = work_hrs;
         this.total_sales = total_sales; }   // end of Constructor method
      
      // method to calculate the commissions respectively
      ...
      return NAME + ID + JAM + HASIL + TOTAL;   }  // end of display salary method
   ...
   public class TestMyFCStaff_modified {  // class TestMyFCStaff
      ...
      MyFCStaff_Ex4 tunjuk = new MyFCStaff_Ex4 (name, staffID, work_hrs, total_sales);     
      System.out.println(tunjuk.toString());      
